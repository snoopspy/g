...
public:
	...
	void ipFlowCreated(GFlow::IpFlowKey* key, GPacketMgr::Value* value) override;
	void ipFlowDeleted(GFlow::IpFlowKey* key, GPacketMgr::Value* value) override;
	...
	void udpFlowCreated(GFlow::UdpFlowKey* key, GPacketMgr::Value* value) override;
	void udpFlowDeleted(GFlow::UdpFlowKey* key, GPacketMgr::Value* value) override;
