...
void GClientHelloSplit::tcpFlowCreated(GFlow::TcpFlowKey* key, GPktMgr::Value* value) {
...
void GClientHelloSplit::tcpFlowDeleted(GFlow::TcpFlowKey* key, GPktMgr::Value* value) {
	(void)key;
	(void)value;
